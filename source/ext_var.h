...
extern LONG cthresh;	/* Compression threshold */
...
extern ITEM oldops;	/* Alternative operators (used by optoggle) */
extern ITEM oldop;	/* Alternative operator bitset (used by optoggle) */
...
extern ITEM fsymtlib;	/* Mapping from function symbol to nlib function no*/
...
extern PREDICATE solving;/* Solving constraint? */
...
extern ITEM constraint;	/* Constraint predicates */
...
extern ITEM fileroot_in,fileroot_out;
			/* Progol fileroot from UNIX command level */
extern ITEM idot0;	/* . */
...
extern PREDICATE condition,conditioning,full_pruning;
